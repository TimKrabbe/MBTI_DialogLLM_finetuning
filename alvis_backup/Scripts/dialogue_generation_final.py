...
df.to_json("/cephyr/users/timkra/Alvis/MA/data/dialogues_comp_run5.json", orient="records", indent=4)
#df.to_json("/cephyr/users/timkra/Alvis/MA/data/dialogues_comp_base_run1.json", orient="records", indent=4)
